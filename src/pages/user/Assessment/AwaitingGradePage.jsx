...
const AwaitingGradePage = () => {
  ...
  return (
    <Box minH="100vh" bg="#F7F9FC" display="flex" alignItems="center" justifyContent="center" px={4}>
      <Box maxW="480px" w="100%" textAlign="center">
        ...
        <Text fontSize="15px" color="gray.500" lineHeight="1.7" mb={6}>
          Your submission has been received. An instructor will review and grade your answers shortly.
        ...
        {autoScore != null && (
          ...
          >
            ...
            <Flex alignItems="baseline" gap={2}>
              <Text fontSize="32px" fontWeight="900" color="#3182CE" lineHeight="1">
                {autoScore.toFixed(1)}
              </Text>
              <Text fontSize="14px" color="gray.400">/ 100</Text>
            </Flex>
