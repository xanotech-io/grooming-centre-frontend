...
// Mock Data
const stats = [
  { label: 'Average Evaluation Time', value: '50mins', subtext: 'Per paper', change: '', changeType: '' },
  { label: 'Marking Accuracy Rate (%)', value: '82%', subtext: '', change: '+5% vs last month', changeType: 'increase' },
  { label: 'Automated Evaluations', value: '50', subtext: '', change: '', changeType: '' },
  { label: 'Re-mark Requests (%)', value: '80%', subtext: 'Per exam', change: '', changeType: '' },
  { label: 'Instructor Evaluation Load', value: '45', subtext: 'Per instructor', change: '', changeType: '' },
];
    ...
    <AdminMainAreaWrapper>
      <Box mb={6} mt={6} as={motion.div} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        <Flex justify="space-between" align="center" mb={10}>
          <Text fontSize="24px" fontWeight="700" color="#101928">Examination Paper Marking</Text>
          <HStack spacing={3}>
      ...
      <Grid templateColumns="repeat(5, 1fr)" gap={4} mb={8}>
        {stats.map((stat, index) => (
          <Box key={index} p={4} bg="white" borderRadius="lg" border="1px solid" borderColor="gray.100" boxShadow="xs">
          ...
          <Table variant="simple" size="sm">
            <Thead bg="gray.50">
              <Tr>
                ...
                <Th px={4} py={3} color="#344054" fontSize="12px" fontWeight="600" textTransform="none" isNumeric>
                  Average Score
                </Th>
                <Th px={4} py={3} color="#344054" fontSize="12px" fontWeight="600" textTransform="none" isNumeric>
                  Highest Score
            ...
            <Tbody>
              {markingData.map((row, idx) => (
                <Tr key={idx}>
                  ...
                  <Td px={2} py={4} color="#101928" fontSize="12px" fontWeight="500">
                    {row.title}
                  </Td>
                  ...
                  <Td px={4} py={4}>
                    <Badge
                      ...
                      color={row.status === 'Completed' ? '#027A48' : '#B54708'}
                    >
                      {row.status}
                    </Badge>
                  </Td>
