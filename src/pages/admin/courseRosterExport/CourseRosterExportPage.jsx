...
const CourseRosterExportPage = () => {
  ...
  useEffect(() => {
    ...
    const loadCourses = async () => {
      ...
      try {
        const { courses: list } = await adminGetCourseListing({ page: 1, limit: 200 });
  ...
  return (
    <AdminMainAreaWrapper>
      <Breadcrumb
        item2={
          <BreadcrumbItem isCurrentPage>
            <Link href="#">Export Course Roster</Link>
          </BreadcrumbItem>
        }
      />
      ...
      <Box backgroundColor="white" padding={8} shadow="md" borderRadius="md">
        ...
        {!courseId ? (
          <Text color="gray.600">Select a course above to export its roster.</Text>
...
export const CourseRosterExportPageRoute = ({ ...rest }) => {
  return <Route {...rest} render={(props) => <CourseRosterExportPage {...props} />} />;
};

export default CourseRosterExportPage;
