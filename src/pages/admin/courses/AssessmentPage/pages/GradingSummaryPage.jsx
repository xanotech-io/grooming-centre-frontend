...
const GradingSummaryPage = () => {
  ...
  useEffect(() => {
    ...
    getAssessmentGradingSummary(assessmentId, params)
      ...
      <Flex justifyContent="space-between" alignItems="flex-start" mb={6} flexWrap="wrap" gap={3}>
        <Box>
          ...
          <Text color="gray.500" fontSize="sm" mt={1}>
            Students who submitted this assessment — click a row to grade
          </Text>
        </Box>
      </Flex>
...
const GradingSummaryPageRoute = ({ ...rest }) => (
  <Route {...rest} render={(props) => <GradingSummaryPage {...props} />} />
);

export default GradingSummaryPageRoute;
